...
INSERT INTO about_content (
  ...
  '["Humanity", "Commitment", "Democratic Culture", "Transparency", "Unity"]'::jsonb,
  '["ሰበዓዊነት", "ቁርጠኝነት", "የዲሞክራሲ ባህል", "ግልጽነት", "አንድነት"]'::jsonb,
  ...
  '["To organize unions and federations", "To protect workers rights", "To improve working conditions", "To provide training and education"]'::jsonb,
  '["በአገሪቱ የአሠሪና ሠራተኛ ግንኙነት ውስጥ የሠራተኛውን አቅም ማሳደግ", "የሠራተኛውን መብት መጠበቅ", "የስራ ሁኔታ ማሻሻል", "ስልጠናና ትምህርት መስጠት"]'::jsonb,
  'Federation Structure', 'የፌዴሬሽኑ አወቃቀር',
  '["President", "Secretary General", "Treasurer", "Organizing Secretary"]'::jsonb,
  '["ፕሬዝዳንት", "ዋና ፀሀፊ", "ክፍያ አስተዳዳሪ", "የማደራጀት ፀሀፊ"]'::jsonb,
  'Key Stakeholders', 'ባለድርሻ አካላት',
  '["Affiliated basic unions", "Peer Federations", "Government agencies", "International organizations"]'::jsonb,
  '["በፌዴሬሽኑ ሥር የተደራጁ መሰረታዊ ማኅበራት", "አቻ ፌዴሬሽኖች", "የመንግሥት አገልግሎቶች", "ዓለም አቀፍ ድርጅቶች"]'::jsonb
) ON CONFLICT DO NOTHING;
