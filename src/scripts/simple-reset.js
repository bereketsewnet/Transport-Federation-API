...
async function resetDatabase() {
  ...
  try {
    ...
    await sequelize.query(`CREATE TABLE about_content (id INT AUTO_INCREMENT PRIMARY KEY, mission_en TEXT, mission_am TEXT, vision_en TEXT, vision_am TEXT, values_en TEXT, values_am TEXT, history_en TEXT, history_am TEXT, objectives_en TEXT, objectives_am TEXT, structure_title_en VARCHAR(255), structure_title_am VARCHAR(255), structure_departments_en TEXT, structure_departments_am TEXT, stakeholders_title_en VARCHAR(255), stakeholders_title_am VARCHAR(255), stakeholders_list_en TEXT, stakeholders_list_am TEXT, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP)`);
    
    await sequelize.query(`CREATE TABLE executives (id INT AUTO_INCREMENT PRIMARY KEY, name_en VARCHAR(255) NOT NULL, name_am VARCHAR(255), position_en VARCHAR(255), position_am VARCHAR(255), bio_en TEXT, bio_am TEXT, photo_filename VARCHAR(500), type ENUM('executive', 'expert') DEFAULT 'executive', display_order INT DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP)`);
    
    await sequelize.query(`CREATE TABLE contact_info (id INT AUTO_INCREMENT PRIMARY KEY, address_en VARCHAR(255), address_am VARCHAR(255), phone VARCHAR(50), email VARCHAR(255), working_hours_en VARCHAR(255), working_hours_am VARCHAR(255), facebook_url VARCHAR(500), twitter_url VARCHAR(500), linkedin_url VARCHAR(500), created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP)`);
